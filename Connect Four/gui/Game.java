...
public class Game extends JFrame {
	...
	public Game() {
		...
		//btn11.setIcon(new ImageIcon(Game.class.getResource("/resources/RedPiece.png")));
		...
		btnCol0.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//once the server tells you what button is needed, you have to change the icon. like so. 
		...
		btnCol1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//this is sample code on how to set the icon backgrounds. Remove this. 
